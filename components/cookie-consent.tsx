      ...
      <Card className="max-w-4xl mx-auto shadow-2xl border-2">
        <CardHeader className="pb-3">
          <div className="flex items-start justify-between">
            <div className="flex items-center space-x-2">
              <Cookie className="h-6 w-6 text-kelly-600" aria-hidden="true" />
              <CardTitle id="cookie-consent-title" className="text-xl">
          ...
          <CardDescription id="cookie-consent-description" className="text-base">
        ...
        <CardContent className="pb-3">
          <p className="text-sm text-gray-600">
            ...
            <Link
              href="/cookie-policy"
              className="text-kelly-600 hover:text-kelly-700 underline font-medium focus:outline-none focus:ring-2 focus:ring-kelly-500 rounded"
            >
              Cookie Policy
            </Link>{" "}
            and{" "}
