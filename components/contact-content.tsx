                  ...
                  {submitStatus === "error" && (
                    <Alert className="mb-6 border-red-200 bg-red-50">
                      <AlertDescription className="text-red-800">
                        Sorry, there was an error sending your message. Please try again or call us directly at{" "}
                      ...
                      {isOutOfServiceArea && (
                        <Alert className="mt-2 border-orange-300 bg-orange-50">
                          ...
                          <AlertDescription className="text-orange-800">
                            ...
                            Please call us at <strong>{BUSINESS.phoneDisplay}</strong> to discuss your project and see
